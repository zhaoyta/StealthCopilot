...
- **数字人输出**：作为说话链的可选输出模式，将 TTS 音频发送给 Simli AI 生成口型同步视频，并通过 OBS Browser Source + OBS Virtual Camera 输出到会议摄像头
...
| Simli AI | 数字人视频口型同步 | 可选；不配置时说话链只输出虚拟麦克风音频 |
...
- 听力链：实时字幕和回答建议
- 说话链：母语语音转目标语言语音；启用数字人时同步输出 Simli 数字人视频
...
| 数字人视频 | Provider 化，默认 Simli AI；本机输出为 OBS Browser Source + OBS Virtual Camera |
...
- 使用真实讯飞 / DeepSeek / 讯飞声音复刻 / Simli / OBS 做端到端联调。
