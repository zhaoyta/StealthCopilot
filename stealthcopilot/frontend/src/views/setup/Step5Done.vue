...
onMounted(async () => {
  try {
    ...
    items.value = [
      { label: t('setup.done.xunfei'), done: cfg.xunfei_app_id_set && cfg.xunfei_api_key_set && cfg.xunfei_api_secret_set },
      { label: t('setup.done.deepseek'), done: cfg.deepseek_key_set },
      { label: t('setup.done.elevenlabs'), done: cfg.elevenlabs_key_set },
      { label: t('setup.done.voiceId'), done: cfg.elevenlabs_voice_id_set },
